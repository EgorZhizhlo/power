...
document.addEventListener('DOMContentLoaded', () => {
  const form = document.getElementById('si-modification-form');
  ...
  form.addEventListener('submit', async (e) => {
    ...
    const jsonData = {
      modification_name: formData.get('modification_name')
    };
    ...
    try {
      ...
      if (response.status === 204) {
        window.location.href = `/companies/si-modifications?company_id=${window.companyId}`;
