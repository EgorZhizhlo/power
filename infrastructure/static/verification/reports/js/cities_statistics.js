/**
 * JavaScript для загрузки и отображения статистики по городам
 */
 ...
 */
async function loadCitiesStatistics(filters = {}) {
    ...
    try {
        ...
        // Отправляем запрос
        const response = await fetch(`/verification/api/reports/cities/?${params.toString()}`);
...
function updateTable(data) {
    ...
    headers.forEach(header => {
        ...
        if (text && text !== '#' && text !== 'Населенный пункт' && 
...
document.addEventListener('DOMContentLoaded', async () => {
    console.log('Инициализация страницы статистики по городам');
